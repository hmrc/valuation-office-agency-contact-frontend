...
import uk.gov.hmrc.vo.contact.frontend.utils.{CheckYourAnswersHelper, DateUtil}
...
class CheckYourAnswersViewSpec extends ViewBehaviours:
  ...
  val propertyAddress1: PropertyAddress = PropertyAddress("a", None, "c", None, "f")
  val userAnswers1                      = FakeUserAnswers(cd, "council_tax", "council_tax_band", "", "", propertyAddress1, tellUs)
  val checkYourAnswersHelper1           = CheckYourAnswersHelper(userAnswers1)

  val propertyAddress2: PropertyAddress = PropertyAddress("a", Some("b"), "c", Some("d"), "f")
  val userAnswers2                      = FakeUserAnswers(cd, "business_rates", "", "business_rates_rateable_value", "", propertyAddress2, tellUs)
  val checkYourAnswersHelper2           = CheckYourAnswersHelper(userAnswers2)

  val anythingElse: Some[String] = Some("AnythingElse")
  val userAnswers3               = FakeUserAnswers(cd, "council_tax", "council_tax_band", "", "", propertyAddress1, tellUs, anythingElse)
  ...
  def view1: () => HtmlFormat.Appendable = () =>
    checkYourAnswers(
      Seq(AnswerSection(
        None,
        Seq(
          checkYourAnswersHelper1.enquiryCategory,
          checkYourAnswersHelper1.councilTaxSubcategory,
          checkYourAnswersHelper1.contactDetails,
          checkYourAnswersHelper1.propertyAddress,
          checkYourAnswersHelper1.tellUsMore()
        ).flatten
      )),
      backlinkUrl
  ...
  def view2: () => HtmlFormat.Appendable = () =>
    checkYourAnswers(
      Seq(AnswerSection(
        None,
        Seq(
          checkYourAnswersHelper2.enquiryCategory,
          checkYourAnswersHelper2.businessRatesSubcategory,
          checkYourAnswersHelper2.contactDetails,
          checkYourAnswersHelper2.propertyAddress,
          checkYourAnswersHelper2.tellUsMore()
        ).flatten
      )),
      backlinkUrl
    )(using fakeRequest, messages)
  ...
  def view3: () => HtmlFormat.Appendable = () =>
    checkYourAnswers(
      Seq(AnswerSection(
        None,
        Seq(
          checkYourAnswersHelper3.enquiryCategory,
          checkYourAnswersHelper3.existingEnquiryCategory,
          checkYourAnswersHelper3.refNumber,
          checkYourAnswersHelper3.contactDetails,
          checkYourAnswersHelper3.propertyAddress,
          checkYourAnswersHelper3.anythingElse
        ).flatten
      )),
      backlinkUrlAE
    )(using fakeRequest, messages)
