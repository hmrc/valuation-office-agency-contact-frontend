...
class BusinessRatesPropertyEnquiryViewSpec extends ViewBehaviours {
  ...
  def view = () => businessRatesPropertyEnquiry(frontendAppConfig, BusinessRatesPropertyForm(), NormalMode)(fakeRequest, messages)

  "Business Rates Property Enquiry view" must {
    behave like normalPage(view, "businessRatesPropertyEnquiry", "title", "heading",
      "england", "wales")
