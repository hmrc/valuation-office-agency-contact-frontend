...
import uk.gov.hmrc.valuationofficeagencycontactfrontend.views.html.annexeRemoved
...
class AnnexeRemovedViewSpec extends ViewBehaviours {
  ...
  def view: () => HtmlFormat.Appendable = () => councilTaxAnnexeRemoved(frontendAppConfig)(fakeRequest, messages)
