...
import uk.gov.hmrc.valuationofficeagencycontactfrontend.views.html.annexeSelfContained
...
class AnnexeSelfContainedViewSpec extends ViewBehaviours {
  ...
  def view: () => HtmlFormat.Appendable = () => councilTaxAnnexeSelfContained(frontendAppConfig)(fakeRequest, messages)
