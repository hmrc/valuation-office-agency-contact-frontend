...
class CheckYourAnswersViewSpec extends ViewBehaviours {
  ...
  val backlinkUrl: String                  = uk.gov.hmrc.valuationofficeagencycontactfrontend.controllers.routes.TellUsMoreController.onPageLoad(NormalMode).url
  val backlinkUrlAE: String                = uk.gov.hmrc.valuationofficeagencycontactfrontend.controllers.routes.AnythingElseTellUsController.onPageLoad().url
