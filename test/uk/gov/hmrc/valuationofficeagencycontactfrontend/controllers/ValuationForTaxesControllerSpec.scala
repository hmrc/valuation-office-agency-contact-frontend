...
class ValuationForTaxesControllerSpec extends ControllerSpecBase {
  ...
  "Valuation For Taxes Controller" must {
    "return 200 for a GET" in {
      val result = new ValuationForTaxesController(frontendAppConfig, messagesApi, MessageControllerComponentsHelpers.stubMessageControllerComponents).onPageLoad()(fakeRequest)
