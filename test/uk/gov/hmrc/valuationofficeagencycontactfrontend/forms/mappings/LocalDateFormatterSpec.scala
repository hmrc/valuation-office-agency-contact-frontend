...
class LocalDateFormatterSpec extends SpecBase {
  ...
  val inputDay: String          = s"$keyValue-day"
  val inputMonth: String        = s"$keyValue-month"
  val inputYear: String         = s"$keyValue-year"
  val year: String              = s"$keyValue.year"
  val month: String             = s"$keyValue.month"
  val day: String               = s"$keyValue.day"
  val invalidDate: String       = s"$keyValue.error.invalidDate"
  val dayMonthRequired: String  = s"$keyValue.error.mandatory.dayMonth"
  val dayYearRequired: String   = s"$keyValue.error.mandatory.dayYear"
  val monthYearRequired: String = s"$keyValue.error.mandatory.monthYear"
  val dayRequired: String       = s"$keyValue.error.mandatory.day"
  val monthRequired: String     = s"$keyValue.error.mandatory.month"
  val yearRequired: String      = s"$keyValue.error.mandatory.year"
  val yearRange: String         = s"$keyValue.error.year.range"
  val dayRange: String          = s"$keyValue.error.day.range"
  val dayNumber: String         = s"$keyValue.error.day.number"
  val monthRange: String        = s"$keyValue.error.month.range"
