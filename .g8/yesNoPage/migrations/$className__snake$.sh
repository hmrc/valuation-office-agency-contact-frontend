...
echo "GET        /$className;format="decap"$                       uk.gov.hmrc.valuationofficeagencycontactfrontend.controllers.$className$Controller.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /$className;format="decap"$                       uk.gov.hmrc.valuationofficeagencycontactfrontend.controllers.$className$Controller.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /change$className$                       uk.gov.hmrc.valuationofficeagencycontactfrontend.controllers.$className$Controller.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /change$className$                       uk.gov.hmrc.valuationofficeagencycontactfrontend.controllers.$className$Controller.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
