...
object PropertyWalesLets140DaysForm {
  def propertyWalesLets140DaysFormatter: Formatter[String] = new Formatter[String] {
  ...
  def apply(): Form[String] =
    Form(single("value" -> of(propertyWalesLets140DaysFormatter)))
