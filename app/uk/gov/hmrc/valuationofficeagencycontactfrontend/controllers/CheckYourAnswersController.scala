...
class CheckYourAnswersController @Inject()(appConfig: FrontendAppConfig,
  ...
  private[controllers] def enquiryKey(answers: UserAnswers): Either[String, String] = {
    (answers.contactReason, answers.enquiryCategory, answers.existingEnquiryCategory, answers.enquiryDate, answers.councilTaxSubcategory, answers.businessRatesSubcategory, answers.fairRentEnquiryEnquiry) match {
      case (Some("more_details"), _, Some("council_tax"), _, _, _, _) => Right("tellUsMore.general")
      case (Some("more_details"), _, Some("business_rates"), _, _, _, _) => Right("tellUsMore.business")
      case (Some("more_details"), _, Some("housing_benefit"), _, _, _, _) => Right("tellUsMore.fairRent")
      case (Some("more_details"), _, Some("other"), _, _, _, _) => Right("tellUsMore.other")
      case (Some("update_existing"), _, Some("council_tax"), _, _, _, _) => Right("tellUsMore.general")
      case (Some("update_existing"), _, Some("business_rates"), _, _, _, _) => Right("tellUsMore.business")
      case (Some("update_existing"), _, Some("housing_benefit"), _, _, _, _) => Right("tellUsMore.fairRent")
      case (Some("update_existing"), _, Some("other"), _, _, _, _) => Right("tellUsMore.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_from_home"), _, _) => Right("tellUsMore.business")
      case (_, Some("business_rates"), _, _, Some("business_rates_other"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_change_valuation"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_bill"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_changes"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_property_empty"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_valuation"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_demolished"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_not_used"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("business_rates"), _, _, Some("business_rates_self_catering"), _, _) => Right("tellUsMore.business.other")
      case (_, Some("council_tax"),  _, Some("council_tax_business_uses"), _, _, _) => Right("tellUsMore.business")
      case (_, Some("council_tax"), Some("council_tax_other"), _,  _, _, _) => Right("tellUsMore.other")
      case (_, Some("council_tax"), Some("council_tax_annexe"), _,  _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_bill"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_band_too_high"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_band_for_new"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_property_empty"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_property_poor_repair"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_property_split_merge"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_property_demolished"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("council_tax"), Some("council_tax_area_change"), _, _, _, _) => Right("tellUsMore.general")
      case (_, Some("housing_benefit"), _, _,  _, Some("submit_new_application"), _) => Right("tellUsMore.fairRent")
      case (_, Some("housing_benefit"), _, _,  _, Some("check_fair_rent_register"), _) => Right("tellUsMore.fairRent")
      case (_, Some("housing_benefit"), _, _,  _, Some("other_request"), _) => Right("tellUsMore.fairRent")
      case (_, Some("council_tax"), _, _, _, _, _) => Right("tellUsMore.ct-reference")
      case (_, Some("business_rates"), _, _, _, _, _) => Right("tellUsMore.ndr-reference")
