...
import uk.gov.hmrc.valuationofficeagencycontactfrontend.views.html.journey.customized.brPropertyOrAreaChangedInEngland

/**
 * @author Yuriy Tumakha
 */
object BRPropertyOrAreaChangedInEngland extends CustomizedContent(
