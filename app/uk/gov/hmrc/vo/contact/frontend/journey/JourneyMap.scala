...
package uk.gov.hmrc.vo.contact.frontend.journey

import play.api.i18n.{I18nSupport, MessagesApi}
import play.api.mvc.Results.NotFound
import play.api.mvc.{ActionRefiner, Request, Result}
import uk.gov.hmrc.vo.contact.frontend.journey.JourneyMap.changeModePrefix
import uk.gov.hmrc.vo.contact.frontend.journey.model.Page
import uk.gov.hmrc.vo.contact.frontend.journey.pages.*
import uk.gov.hmrc.vo.contact.frontend.models.requests.DataRequest
import uk.gov.hmrc.vo.contact.frontend.views.html.error.page_not_found
...
/**
  ...
  */
@Singleton
class JourneyMap @Inject() (pageNotFound: page_not_found, override val messagesApi: MessagesApi)(using ec: ExecutionContext) extends I18nSupport:
  ...
  def getPage(key: String): ActionRefiner[DataRequest, JourneyPageRequest] =
    new ActionRefiner[DataRequest, JourneyPageRequest]:
