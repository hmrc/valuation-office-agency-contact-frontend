...
import uk.gov.hmrc.vo.contact.frontend.repositories.SessionRepository
...
class DataCacheConnectorImpl @Inject() (
  ...
  def addToCollection[A](cacheId: String, collectionKey: String, value: A)(using fmt: Format[A]): Future[CacheMap] =
